  ...
  static I18n buildI18n() {
    return I18n(
      ...
      filterEditor: I18nFilterEditor(
        ...
        filters: I18nFilters(
          none: LocaleKeys.filter_none.tr,
          addictiveBlue: LocaleKeys.filter_addictive_blue.tr,
          addictiveRed: LocaleKeys.filter_addictive_red.tr,
          aden: LocaleKeys.filter_aden.tr,
          amaro: LocaleKeys.filter_amaro.tr,
          ashby: LocaleKeys.filter_ashby.tr,
          brannan: LocaleKeys.filter_brannan.tr,
          brooklyn: LocaleKeys.filter_brooklyn.tr,
          charmes: LocaleKeys.filter_charmes.tr,
          clarendon: LocaleKeys.filter_clarendon.tr,
          crema: LocaleKeys.filter_crema.tr,
          dogpatch: LocaleKeys.filter_dogpatch.tr,
          earlybird: LocaleKeys.filter_earlybird.tr,
          f1977: LocaleKeys.filter_1977.tr,
          gingham: LocaleKeys.filter_gingham.tr,
          ginza: LocaleKeys.filter_ginza.tr,
          hefe: LocaleKeys.filter_hefe.tr,
          helena: LocaleKeys.filter_helena.tr,
          hudson: LocaleKeys.filter_hudson.tr,
          inkwell: LocaleKeys.filter_inkwell.tr,
          juno: LocaleKeys.filter_juno.tr,
          kelvin: LocaleKeys.filter_kelvin.tr,
          lark: LocaleKeys.filter_lark.tr,
          loFi: LocaleKeys.filter_lo_fi.tr,
          ludwig: LocaleKeys.filter_ludwig.tr,
          maven: LocaleKeys.filter_maven.tr,
          mayfair: LocaleKeys.filter_mayfair.tr,
          moon: LocaleKeys.filter_moon.tr,
          nashville: LocaleKeys.filter_nashville.tr,
          perpetua: LocaleKeys.filter_perpetua.tr,
          reyes: LocaleKeys.filter_reyes.tr,
          rise: LocaleKeys.filter_rise.tr,
          sierra: LocaleKeys.filter_sierra.tr,
          skyline: LocaleKeys.filter_skyline.tr,
          slumber: LocaleKeys.filter_slumber.tr,
          stinson: LocaleKeys.filter_stinson.tr,
          sutro: LocaleKeys.filter_sutro.tr,
          toaster: LocaleKeys.filter_toaster.tr,
          valencia: LocaleKeys.filter_valencia.tr,
          vesper: LocaleKeys.filter_vesper.tr,
          walden: LocaleKeys.filter_walden.tr,
          willow: LocaleKeys.filter_willow.tr,
          xProII: LocaleKeys.filter_x_pro_ii.tr,
        ),
      ),
      ...
      widgets: PaintEditorWidgets(
        appBar: (paintEditor, rebuildStream) => ReactiveAppbar(
          ...
          builder: (_) => SubEditorAppBar(
            ...
            toolTitle: LocaleKeys.tools_draw.tr,
      ...
      widgets: CropRotateEditorWidgets(
        appBar: (cropRotateEditor, rebuildStream) => ReactiveAppbar(
          ...
          builder: (_) => SubEditorAppBar(
            ...
            toolTitle: LocaleKeys.tools_crop.tr,
      ...
      widgets: FilterEditorWidgets(
        ...
        appBar: (editorState, rebuildStream) => ReactiveAppbar(
          ...
          builder: (_) => SubEditorAppBar(
            ...
            toolTitle: LocaleKeys.tools_filter.tr,
          ),
        ),
        bottomBar: (editorState, rebuildStream) {
          return ReactiveWidget(
      ...
      widgets: TuneEditorWidgets(
        appBar: (editor, rebuildStream) => ReactiveAppbar(
          ...
          builder: (_) => SubEditorAppBar(
            ...
            onDone: editor.done,
            toolTitle: LocaleKeys.tools_tune.tr,
            onUndo: editor.undo,
            onRedo: editor.redo,
      ...
      widgets: BlurEditorWidgets(
        appBar: (blurEditor, rebuildStream) => ReactiveAppbar(
          ...
          builder: (_) => SubEditorAppBar(
            ...
            toolTitle: LocaleKeys.tools_blur.tr,
          ),
        ),
        bottomBar: (editorState, rebuildStream) {
          return ReactiveWidget(
